...
const baseUrls = [
  {
    ...
    description: "Comptes de test fictifs",
    color: "blue",
    icon: Terminal,
  },
  {
...
const concepts = [
  {
    title: "Multi-comptes",
    description: "Gérez plusieurs comptes (courant, épargne, joint) depuis une seule interface.",
    icon: Wallet,
  },
  {
    title: "IBAN français",
    description: "Chaque compte dispose d'un IBAN français valide pour les virements SEPA.",
    icon: Building,
  },
  {
    title: "Solde temps réel",
    description: "Visualisez votre solde en temps réel avec historique des transactions.",
    icon: TrendingUp,
  },
  {
    title: "Virements",
    description: "Effectuez des virements SEPA et instantanés depuis vos comptes.",
    icon: ArrowRight,
  },
];

const accountTypes = [
  { type: "COURANT", name: "Compte courant", description: "Pour vos opérations quotidiennes" },
  { type: "EPARGNE", name: "Compte épargne", description: "Pour vos projets d'épargne" },
  { type: "JOINT", name: "Compte joint", description: "Partagé avec un autre titulaire" },
  { type: "PRO", name: "Compte professionnel", description: "Pour votre activité" },
];
...
const endpoints = [
  ...
  {
    method: "GET",
    path: "/users/me/accounts/:id/balance",
    description: "Solde d'un compte",
    parameters: ["id"],
  },
  {
    method: "GET",
    path: "/users/me/accounts/:id/transactions",
    description: "Transactions d'un compte",
    parameters: ["id", "from_date", "to_date", "limit"],
  },
  {
    method: "POST",
    path: "/users/me/accounts",
    description: "Créer un compte",
    parameters: ["type", "currency", "name"],
  },
];
...
const webhookEvents = [
  ...
  },
  {
    ...
    payload: "account_id, type, iban",
  },
];

const codeExamples = {
  listAccounts: {
    title: "Lister mes comptes",
    description: "Récupérez tous vos comptes avec leurs soldes.",
    code: `curl -X GET https://sandbox.bank.skygenesisenterprise.com/api/v1/users/me/accounts \\
...
# Réponse:
{
  "data": [
    ...
    },
    {
      ...
      "type": "EPARGNE",
      "name": "Livret A",
      "iban": "FR7630004000123456789012892",
      "bic": "BNORFRPP",
      "balance": 900000,
  ...
  accountDetails: {
    ...
    description: "Obtenez les détails complets d'un compte spécifique.",
    code: `curl -X GET https://sandbox.bank.skygenesisenterprise.com/api/v1/users/me/accounts/acc_xyz789 \\
  -H "Authorization: Bearer sk_test_abc123"
...
# Réponse:
{
  ...
  accountBalance: {
    title: "Solde d'un compte",
    description: "Récupérez le solde d'un compte spécifique.",
    code: `curl -X GET https://sandbox.bank.skygenesisenterprise.com/api/v1/users/me/accounts/acc_xyz789/balance \\
  -H "Authorization: Bearer sk_test_abc123"
...
# Réponse:
{
  ...
  "currency": "EUR",
  "overdraft_limit": 100000,
  "overdraft_available": 100000,
  "updated_at": "2026-03-31T10:00:00Z"
}`,
  },
  createAccount: {
    title: "Créer un compte",
    description: "Ouvrez un nouveau compte.",
    code: `curl -X POST https://sandbox.bank.skygenesisenterprise.com/api/v1/users/me/accounts \\
  -H "Authorization: Bearer sk_test_abc123" \\
...
# Réponse:
{
  ...
  "type": "EPARGNE",
  "name": "Compte voyage",
  "iban": "FR7630004000123456789012893",
  "bic": "BNORFRPP",
  "balance": 0,
  "currency": "EUR",
  "status": "pending_kyc",
    ...
    <div className="max-w-5xl mx-auto p-8 space-y-16">
      ...
      <section className="text-center space-y-6">
        ...
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
          API <span className="text-primary">Comptes</span>
        </h1>
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          API pour la gestion de vos comptes bancaires. Solde en temps réel, historique et création
          de nouveaux comptes.
        </p>
...
curl -X GET https://sandbox.bank.skygenesisenterprise.com/api/v1/users/me/accounts \\
  -H "Authorization: Bearer sk_test_abc123" \\
  -H "Content-Type: application/json"`}
          </pre>
        </div>
      ...
      <section className="rounded-xl bg-gradient-to-r from-primary/10 to-primary/5 p-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-xl font-semibold mb-2">Prêt à gérer vos comptes ?</h2>
            <p className="text-muted-foreground">
              Explorez les transactions ou découvrez les produits d&apos;épargne.
            </p>
          </div>
